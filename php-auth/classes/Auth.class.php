...
class User
{
    ...
    public function getSalt($username) {
        $query = "select salt from users1 where username = :username limit 1";
    ...
    {
        $query = "select id, username from users1 where
    ...
    public function create($username, $password) {
        ...
        $query = "insert into users1 (username, password, salt)
